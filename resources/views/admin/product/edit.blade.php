                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ old('slug', $product->slug) }}" readonly>
                                    @error('slug')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="image" id="image" value="{{ old('image', $product->image) }}" multiple>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <input class="custom-control-input" type="checkbox" id="track_qty" name="track_qty" value="Yes" {{ old('track_qty', $product->track_qty) === 'Yes' ? 'checked' : '' }}>
...
{{--                                <div class="mb-3">--}}
{{--                                    <div class="custom-control custom-checkbox">--}}
{{--                                        <input type="hidden" name="track_qty" value="no"> <!-- Hidden field to handle unchecked state -->--}}
{{--                                        <input class="custom-control-input" type="checkbox" id="track_qty" name="track_qty" value="yes" {{ old('track_qty', $product->track_qty) == 'yes' ? 'checked' : '' }}>--}}
{{--                                        <label for="track_qty" class="custom-control-label">Track Quantity</label>--}}
{{--                                    </div>--}}
...
{{--                                    --}}{{--                                        @endif--}}
{{--                                    --}}{{--                                    </select>--}}
{{--                                    <select name="subCategory_category_id" id="subCategory" class="form-control">--}}
{{--                                        <option value="">Select a Category</option>--}}
{{--                                        @if($subCategories->isNotEmpty())--}}
{{--                                            @foreach($subCategories as $subCategory)--}}
{{--                                                <option value="{{ $subCategory->id }}"--}}
{{--                                                    {{ old('subCategory_category_id', $category->subCategory_category_id) == $subCategory->id ? 'selected' : '' }}>--}}
{{--                                                    {{ $subCategory->name }}--}}
{{--                                                </option>--}}
{{--                                            @endforeach--}}
{{--                                        @endif--}}
